...
#[derive(Component)]
pub struct CoreGlow { pub layer: u32 }

#[derive(Component)]
pub struct LightOrb { pub angle: f32, pub speed: f32, pub radius: f32, pub phase: f32 }

#[derive(Component)]
pub struct EnergyWisp { pub id: u32 }

#[derive(Component)]
pub struct OrbPointLight { pub base: f32, pub phase: f32 }
...
fn setup_panorama(
    ...
    for i in 0..16 {
        ...
        commands.spawn((
            ...
            Transform::from_xyz(0.0, ORB_Y, 0.0).with_scale(Vec3::splat(0.5 + (i % 3) as f32 * 0.3)),
            LightOrb { angle, speed, radius, phase: i as f32 * 0.4 },
        ));
    }
    ...
    commands.spawn((
        ...
        Transform::from_xyz(0.0, ORB_Y, 0.0),
        OrbPointLight { base: 50000.0, phase: 0.0 },
    ));
    ...
    for i in 0..4 {
        ...
        commands.spawn((
            ...
            OrbPointLight { base: 8000.0, phase: i as f32 * 1.5 },
        ));
    }
...
fn animate_core_glow(
    ...
    let cam_yaw = cam_q.single().map(|c| {
...
fn animate_point_lights(
    time: Res<Time>,
    mut lights: Query<(&mut PointLight, &OrbPointLight)>,
) {
    let t = time.elapsed_secs();
